...
/// <summary>Displays the clear panel and publishes its home request.</summary>
public sealed class HexClearPanel : MonoBehaviour
{
    ...
    {
        bool show = payload.Result == HexGameResult.Cleared;
